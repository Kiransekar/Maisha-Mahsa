...
- [~] WS7 UX research done (docs/WS7_UX_RESEARCH.md, 81 cited findings) → [ ] WS7.1–7.10 + WS7.V  · [~] WS8.1 audit pack (core slice) · [ ] WS8.2–8.3  · [ ] WS9.1 · [x] WS9.2 bank parsers · [x] WS9.3 · [h] WS9.4 GSP
