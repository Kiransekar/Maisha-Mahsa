...
| **T5** Portal collapse, no recovery path | Name the statute, don't say "compliance" | "Portal down" must be visually distinct from "your filing is wrong", and attempt-evidence must be exportable for penalty waivers. | ⏳ |
